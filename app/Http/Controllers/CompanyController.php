...
class CompanyController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->govt_logo != null){
            $logoImage = '_logo_'.uniqid().'.'.$request->logo->extension();
            $request->govt_logo->move(public_path('upload_images/company_logo/'),$logoImage);
            $model->govt_logo = $logoImage;
        }
    ...
    function update(Request $request){
        ...
        if($request->govt_logo != null){
            $logoImage = '_logo_'.uniqid().'.'.$request->govt_logo->extension();
            $request->govt_logo->move(public_path('upload_images/company_logo/'),$logoImage);
            $model->govt_logo = $logoImage;
        }
        $model->name                = $request->post('name');
