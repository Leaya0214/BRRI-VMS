                ...
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body p-3">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @php $i = 0; @endphp
                                @foreach ($vehicleExpenseCategory as $item)
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td>{{ $item->name }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('vehicle-expense-categories-delete', $item->id) }}"
    ...
    <div class="modal fade create_modal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('vehicle-expense-categories-store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade update update-modal-{{ $item->id }}" id="exampleModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('vehicle-expense-categories-update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="form-group row pt-3">
                                ...
                                <label for="" class="col-sm-1 col-form-label">:</label>
                                <div class="col-sm-8">
                                    <input name="name" type="text" class="form-control" value="{{$item->name}}" placeholder="Category Name">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
