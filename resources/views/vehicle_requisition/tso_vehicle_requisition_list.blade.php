                        ...
                        <tr>
                           ...
                           <td>{{ \Carbon\Carbon::parse($requisition->usage_date)->format('d/m/Y') ?? '' }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('requisition.forward', $requisition->id) }}" class="btn btn-secondary btn-sm">Approve</a>
                                @endif --}}
                                @if($requisition->assign_status != 1)
                                    <a href="{{ route('vehicle.assign', $requisition->id) }}" class="btn btn-secondary btn-sm">Assign</a>
                                @endif
                                {{-- <a href="{{ route('requisition.rejectrequisition.reject', $requisition->id) }}" class="btn btn-danger btn-sm">Reject</a> --}}
