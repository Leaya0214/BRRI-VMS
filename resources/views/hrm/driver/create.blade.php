                                        ...
                                        <div class="card card-success card-outline">
                                            ...
                                            <div class="card-body p-3">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control"
                                                            placeholder="Driver Name" name="name" required>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                     ...
                                                     <label for="gross_salary" class="col-sm-2 col-form-label">User Role<span class="text-danger">*</span></label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group row">
                                                    <label for="signature" class="col-sm-2 col-form-label">Driver Signature<span class="text-danger"></span></label>
                                                   <div class="col-sm-4">
                                                      <input type="file" class="form-control" name="signature" placeholder="">
                                                   </div>
                                                    <label for="signature" class="col-sm-2 col-form-label">Driver Image<span class="text-danger"></span></label>
                                                   <div class="col-sm-4">
                                            ...
                                            <div class="card-footer">
                                                <button class="btn btn-success btn-block" type="submit">
                                                    <i class="fa fa-check"></i> Create Driver
                                                </button>
                                            </div>
                                        </div>
                                    </div>
