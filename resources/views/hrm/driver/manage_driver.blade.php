            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2 p-2">
                        ...
                        <a href="{{route('create-driver')}}" class="text-end col-sm-2 btn btn-success btn-sm">+Add Driver</a>
                        {{-- <div class="col-md-3">
                            <label>Company</label>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-toggle="modal" onclick="load_edit_body('{{$item->id}}')" data-target="#modal-view" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></button>
                                    <a href="{{ route('edit-driver',[$item->id]) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
