                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label for="section_id" class="col-sm-2 col-form-label">Division<span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-sm-4">
                                                        <select name="section_id" class="form-control select2" id="section_id" onchange="loadDesignationsBySection(this.value)">
                                                ...
                                                <div class="form-group row">
                                                   <label for="gross_salary" class="col-sm-2 col-form-label">Blood
                                                    ...
                                                    <label for="job_location" class="col-sm-2 col-form-label">Employee Role
                                                        <span class="text-danger">*</span></label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label for="signature" class="col-sm-2 col-form-label">Employee Image<span class="text-danger"></span></label>
                                                    <div class="col-sm-4">
                                                        @if($employee->image)
                                                ...
                                                <div class="form-group row mt-2">
                                                    ...
                                                    <select name="is_head" id="is_head" class="form-control col-md-3">
                                                        <option value="1" {{ old('is_head', $employee->is_head) == 1 ? 'selected' : '' }}>Yes</option>
                                                        <option value="0" {{ old('is_head', $employee->is_head) == 0 ? 'selected' : '' }}>No</option>
                                                    </select>
