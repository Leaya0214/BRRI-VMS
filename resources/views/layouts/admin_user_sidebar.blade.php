    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column"
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('manage-driver') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'mannage-driver' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Manage Driver</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ isset($main_menu) && $main_menu == 'vehicle-management' ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link {{ isset($main_menu) && $main_menu == 'vehicle-management' ? 'active' : '' }}">
                        <i class="nav-icon fas fa-th-large "></i>
                        <p>
                            Vehicle Management
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('vehicle-types') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'vehicle-type' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Vehicle Type</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('vehicles-setup') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'setup-vehicle' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Setup-Vehicle</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('vehicles') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'vehicle' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Vehicle</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('vehicle-expense-categories') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'vehicle-expense-category' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Vehicle-Expense-Category</p>
                            </a>
                        </li>
                    </ul>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('vehicle-expense-heads') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'vehicle-expense-head' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('expense-details-add') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'add-expense-details' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Expense Details</p>
                            </a>
                        </li>
                    </ul>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('expense-details-index') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'expense-details' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All expense</p>
                            </a>
                        </li>
                 ...
                 {{-- {{-- @if (array_search('vendor', array_column($menu_permission, 'menu_slug')) !== false) --}}
                    ...
                    <ul class="nav nav-treeview">
                         ...
                         <li class="nav-item">
                            <a href="{{route('vehicle.requisition.list')}}" class="nav-link {{((isset($child_menu) && $child_menu=='vehicle-requisition-list')?'active':'')}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Employee Requisition List</p>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <a href="#" class="nav-link {{((isset($main_menu) && $main_menu=='basic_settings')?'active':'')}} ">
                      ...
                      <p>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('division-list')}}" class="nav-link {{((isset($child_menu) && $child_menu=='division-list')?'active':'')}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Division</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('notices') }}"
                                    class="nav-link {{ isset($child_menu) && $child_menu == 'mannage-notice' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Notice</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('sliders') }}"
                                    class="nav-link {{ isset($child_menu) && $child_menu == 'slider' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Slider</p>
                                </a>
                            </li>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">
                    <b class="text-info">{{ (session()->get('employee_name')) ?session()->get('employee_name'):'' }}</b>
                    <br/>@ {{ (session()->get('employee_role')) ? session()->get('employee_role'):'' }}<small class="text-success">
                        {{-- @if (auth()->user()->role == 1)
                            DGM
                        @elseif (auth()->user()->role == 2)
                            Director
                ...
                <li class="nav-item">
                 ...
                 {{-- {{-- @if (array_search('vendor', array_column($menu_permission, 'menu_slug')) !== false) --}}
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @if(session()->get('employee_role') == 'Staff' && session()->get('is_head') == 1)
                            <li class="nav-item">
                                <a href="{{route('vehicle.requisition.head.list')}}" class="nav-link {{((isset($child_menu) && $child_menu=='director-vehicle-requisition-list')?'active':'')}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Employee Requisition List</p>
                                </a>
                            </li>
                        @elseif(session()->get('employee_role') == 'Director')
                            <li class="nav-item">
                                <a href="{{route('vehicle.requisition.director.list')}}" class="nav-link {{((isset($child_menu) && $child_menu=='director-vehicle-requisition-list')?'active':'')}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Employee Requisition List</p>
                                </a>
                            </li>
                        @elseif(session()->get('employee_role') == 'DGM')
                        <li class="nav-item">
                            <a href="{{route('vehicle.requisition.dgm.list')}}" class="nav-link {{((isset($child_menu) && $child_menu=='vehicle-requisition-list')?'active':'')}}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Employee Requisition List</p>
                            </a>
                        </li>
                        @elseif(session()->get('employee_role') == 'TSO')
                            <li class="nav-item">
                                <a href="{{route('vehicle.requisition.tso.list')}}" class="nav-link {{((isset($child_menu) && $child_menu=='vehicle-requisition-list')?'active':'')}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Employee Requisition List</p>
                                </a>
                            </li>
